...
export default class Employee {
  ...
  // Class Methods
  getHourlyWage() {
    console.log(`${this.name} earns ${this.hourlyRate} euros per hour.`);
    console.log(this.periodStart);
  }

  getDailyWage() {
    const dailyRate = this.hourlyRate * this.dailyHours;
    console.log(`${this.name} earns ${dailyRate} euros per day.`);
  }
  ...
  getWageInPeriod() {
    ...
    // console.log(days);
    // Subtract Public Holidays - TO IMPLEMENT STILL
    ...
    console.log(
      `${
        this.name
      } earned €${totalWageInPeriod} between ${this.periodStart.getDate()}-${this.periodStart.getMonth() +
